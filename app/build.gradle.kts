...
android {
    defaultConfig {
        applicationId = "com.maciejbandel.guidebook"
    ...
    buildTypes {
        val debug by getting {
            applicationIdSuffix = GuidebookBuildType.DEBUG.applicationIdSuffix
        }
        val release by getting {
            isMinifyEnabled = true
            applicationIdSuffix = GuidebookBuildType.RELEASE.applicationIdSuffix
            proguardFiles(
    ...
    namespace = "com.maciejbandel.guidebook"
}
